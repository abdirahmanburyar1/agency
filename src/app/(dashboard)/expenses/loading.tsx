    ...
    <main className="w-full py-6 sm:py-8">
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex gap-4">
          ...
          <div className="h-10 w-36 animate-pulse rounded bg-zinc-200 dark:bg-zinc-700" />
        </div>
      </div>
      ...
      <div className="overflow-hidden rounded-lg border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
        <div className="flex gap-4 border-b border-zinc-200 bg-zinc-50 px-4 py-3 dark:border-zinc-800 dark:bg-zinc-950">
            ...
            <div key={i} className="flex gap-4 px-4 py-3">
              {Array.from({ length: 6 }).map((_, j) => (
                <div
                  ...
                  style={{ maxWidth: j === 0 ? 90 : undefined }}
                />
              ))}
            </div>
          ))}
